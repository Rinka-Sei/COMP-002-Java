...
public class Oct_08_2025 {
    ...
    public static void main(String[] args) {
        try (Scanner scan = new Scanner(System.in)) {
            ...
            // Oct_08_2025 1 Part A. 3 nums output sum, diff, prod, quotient
            System.out.println("-----------------------------------------------------------------------------------------------------------------------------------------------");
            ...
            // Oct_08_2025 1 Part B. Raise the number to the 3rd power / Compute for a cube of a number
            System.out.println("-----------------------------------------------------------------------------------------------------------------------------------------------");
            ...
            // Oct_08_2025 2 Part A. Average of 15 numbers
            System.out.println("-----------------------------------------------------------------------------------------------------------------------------------------------");
            ...
            // Oct_08_2025 2 Part B. Degrees to Revolution Converter
            System.out.println("-----------------------------------------------------------------------------------------------------------------------------------------------");
